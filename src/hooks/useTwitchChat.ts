...
export function useTwitchChat(channel: string, fadeSeconds: number = 0, ignoredUsers: string[] = [], notificationSound: boolean = true) {
  ...
  useEffect(() => {
    ...
    const { disconnect } = createTwitchClient(channel, (msg) => {

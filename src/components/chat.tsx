        ...
        {allMessages.map((msg, i) => (
          ...
          >
            ...
            <div
              ...
              className={cn(
                "relative w-fit rounded-xl border-2 border-transparent bg-(--subtle-color) px-3 py-2 font-medium text-pretty shadow-[0_3px_12px_rgba(0,0,0,0.4)] group-last:border-(--tint-color)",
